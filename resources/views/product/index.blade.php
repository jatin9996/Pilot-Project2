...
@section('title', __('labels.productList'))
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">{{ __('menu.products') }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        var PreVisionSoftTechDatatablesDataSourceAjaxServer = function () {
            ...
            var actionList = function (data) {
                var editUrl = '{{ route('admin.products.edit', ['product' => ':product']) }}',
                    editAction = '<a href="' + editUrl.replace(':product', data.id) + '" class="dropdown-item" data-id=' + data.id + '><i class="icon-pencil7"></i>{{ __('labels.edit') }}</a>';
