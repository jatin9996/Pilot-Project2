...
<head>
    ...
    <title>{{ __('Test') }} | {{ __('labels.signIn') }}</title>
    ...
    <div class="content-wrapper">
        <div class="content d-flex justify-content-center align-items-center">
            ...
            <form class="login-form"
                  action="{{ route('admin.login') }}" method="post" id="login-form">
                @csrf
                @method('post')
                <div class="card mb-0">
                    <div class="card-body">
                        <div class="text-center mb-3">
                            ...
                            <h5 class="mb-0">{{ __('labels.signIn') }}</h5>
                        </div>
                        ...
                        <div class="form-group d-flex align-items-center">
                            ...
                            {{--                            <a href="#" class="ml-auto">{{ __('labels.forgotPassword') }}?</a>--}}
                        </div>

                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-block">{{ __('labels.signIn') }} <i
                        ...
                        <div class="form-group">
                            <a href="{{ route('admin.register') }}"
                               class="btn btn-light btn-block">{{__('labels.register')}}</a>
                        </div>
                    </div>
                </div>
            </form>
